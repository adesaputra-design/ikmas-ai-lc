        ...
        <aside class="admin-sidebar" id="admin-sidebar">
            <div>
                ...
                <nav class="admin-nav">
                    ...
                    <a href="{{ url('/admin/subscribers') }}" class="admin-nav-item {{ request()->is('admin/subscribers*') ? 'active' : '' }}">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                            <circle cx="8.5" cy="7" r="4"></circle>
                            <polyline points="17 11 19 13 23 9"></polyline>
                        </svg>
                        <span>Subscriber Publik</span>
                    </a>
                    @endif
                    ...
                    @if(auth()->user()->hasPermission('library'))
                    <a href="{{ url('/admin/library') }}" class="admin-nav-item {{ request()->is('admin/library*') ? 'active' : '' }}">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path>
                            <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path>
